...
"""
4-Hour LSTM Forecasting Transfer Model [TL-c: Output linear layer + LSTM input weights are re-trained]
...
for bootstrap_index in range(num_bootstraps):
    ...
    'TL-c'
    # the input weights from inputs (W) were allowed to change
    # W, B, Wih, Wfh, Wch, Woh
