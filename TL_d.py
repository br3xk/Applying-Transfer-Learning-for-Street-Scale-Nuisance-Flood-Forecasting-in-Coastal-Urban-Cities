...
"""
4-Hour LSTM Forecasting Transfer Model [TL-d: All weights and biases are re-trained]
...
for bootstrap_index in range(num_bootstraps):
    ...
    'TL-d'
    # all weights (W, U) and bias (B) in the network were allowed to be updated
    # W, B, Uih, Ufh, Uch, Uoh, Wih, Wfh, Wch, Woh, Bi, Bf, Bc, Bo
    
    # all are allowed to train, no freezing
