...
"""
4-Hour LSTM Forecasting Transfer Model [TL-b: Output linear layer + LSTM recurrent weights are re-trained]
...
for bootstrap_index in range(num_bootstraps):
    ...
    'TL - b'
    # the weights of the recurrent connections from hidden states (U) were allowed to change
    # W, B, Uih, Ufh, Uch, Uoh
